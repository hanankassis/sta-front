...
const AdminHeader = ({onToggleSidebar}) => {
  ...
  return (
    <nav className="admin-header" dir="rtl">      
      <div className="brand">
        <button className="btn btn-success-light" onClick={onToggleSidebar} aria-label="toggle-sidebar" title="إظهار/إخفاء الشريط الجانبي"><i className='fa fa-arrow-left'></i></button>
